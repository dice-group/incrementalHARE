...
savepath="/upb/scratch/departments/pc2/groups/hpc-prf-dsg/desouki/mats/wdnewjun/"
    ...
    print(load(paste0("/upb/scratch/departments/pc2/groups/hpc-prf-dsg/desouki/mats/wdjan/","Sn_wd04012018_26_d",damping*100,".RData")))
    Sn_jan=previous
    print(load(paste0("/upb/scratch/departments/pc2/groups/hpc-prf-dsg/desouki/mats/wddelta/","Sn_wd13062018delta_26_d",damping*100,".RData")))
    Sn_delta=previous
    print(load(paste0("/upb/scratch/departments/pc2/groups/hpc-prf-dsg/desouki/mats/wdnewjun/","Sn_wdnewjun_26_d",damping*100,".RData")))
    Sn_newjun=previous
    tl=proc.time()
    print(tl-tl0)
 ti0=proc.time()
...
print("Calc inc_orank ...")
incRank=rank(-el,ties.method="first")
newjunRank=rank(-Sn_newjun,ties.method="first")
...
print(sprintf('max SE=%11.5e, max incRank=%.2f,max newjunRank=%.2f, rG1=%f',max(SE),max(incRank),max(newjunRank),rG[1]))
