...
name="wd04012018"
savepath="/upb/scratch/departments/pc2/groups/hpc-prf-dsg/desouki/mats/wdjan/"
...
tch_sz = 1e5*c(4,15,rep(100,10),rep(1000,3))
	...
	write.csv(file=paste(savepath , "results_resources_" , name ,"_d",damping*100, "_HARE_hd.csv",sep=''),tmp,row.names=FALSE)
