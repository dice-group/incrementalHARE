...
savepath="/upb/scratch/departments/pc2/groups/hpc-prf-dsg/desouki/mats/wdnewjun/"
    ...
    print(load(paste0("/upb/scratch/departments/pc2/groups/hpc-prf-dsg/desouki/mats/wdjan/","Sn_wd04012018_38_d",damping*100,".RData")))
    Sn_jan=previous
    print(load(paste0("/upb/scratch/departments/pc2/groups/hpc-prf-dsg/desouki/mats/wddelta/","Sn_wd13062018delta_40_d",damping*100,".RData")))
    Sn_delta=previous
    print(load(paste0("/upb/scratch/departments/pc2/groups/hpc-prf-dsg/desouki/mats/wdnewjun/","Sn_wdnewjun_38_d",damping*100,".RData")))
    Sn_newjun=previous
    tl=proc.time()
    print(tl-tl0)
 ti0=proc.time()
